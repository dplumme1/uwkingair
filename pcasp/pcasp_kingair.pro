...
nc_path_filename  = '/netdata/kingair_data/pecan15/work/' + nc_filename
;hhmmsss_size_dist = [-1.]
;hhmmsse_size_dist = [-1.]
...
ps_path_filename = './pcasp_kingair_' + ps_filename_frag + '_.ps'
...
;
 ...
 if index_count gt 0 then begin
  dndlog10d  = total(cnts(index,*), [1]) / (pflwc[index] * index_count * adia_dlog10d)
;
